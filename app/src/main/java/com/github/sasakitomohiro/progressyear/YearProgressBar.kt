...
private const val max: Float = 100f

class YearProgressBar @JvmOverloads constructor(
    context: Context,
    ...
    fun setProgressWithAnimation(@FloatRange(from = 0.0, to = 100.0) currentProgress: Float) {
